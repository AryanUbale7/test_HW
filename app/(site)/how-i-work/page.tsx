    ...
    <div className="bg-ivory">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-20 md:py-32">
        ...
        <div className="space-y-24 mb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-4xl md:text-5xl font-serif font-bold text-deep-green mb-8">My approach</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center md:flex-row-reverse">
            <div className="md:order-2">
              ...
              <h3 className="text-4xl md:text-5xl font-serif font-bold text-deep-green mb-8">The three arms</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-4xl md:text-5xl font-serif font-bold text-deep-green mb-8">How we begin</h3>
              <p className="font-sans text-charcoal leading-relaxed">
        ...
        <Card className="max-w-3xl mx-auto scroll-mt-32" id="compensation">
          <h3 className="text-3xl md:text-4xl font-serif font-bold text-deep-green mb-8">How I'm compensated</h3>
          ...
          <h3 id="do-and-dont" className="text-3xl md:text-4xl font-serif font-bold text-deep-green mb-8 scroll-mt-32 border-t border-sage/20 pt-10">What I do — and don't — do</h3>
