        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 pb-16">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-4 font-sans font-light text-ivory/70">
              ...
              <Link href="/reach-me" className="hover:text-[#E5C158] transition-colors w-fit flex items-center gap-2 mt-3 font-medium text-ivory focus-visible:ring-2 focus-visible:ring-[#E5C158] focus:outline-none rounded-sm">
