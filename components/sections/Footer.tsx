  ...
  return (
    <footer className="bg-deep-green text-ivory">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16 w-full pt-6 md:pt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 pb-4">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-4 font-sans font-light text-ivory/70 text-sm">
              ...
              <Link 
                href="/reach-me" 
                className="hover:text-[#E5C158] hover:border-[#E5C158]/50 hover:bg-[#E5C158]/5 transition-all duration-300 w-fit flex items-center gap-2 mt-3 font-semibold text-ivory px-4 py-2 border border-ivory/20 rounded-full text-xs tracking-wider uppercase focus-visible:ring-2 focus-visible:ring-[#E5C158] focus:outline-none"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-[#E5C158] w-3.5 h-3.5"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
        ...
        {/* 2. Divider */}
        <hr className="border-t border-slate-700/30 my-1" />
