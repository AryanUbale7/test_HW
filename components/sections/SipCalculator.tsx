          ...
          <div className="bg-sage-mist/30 border border-sage/20 rounded-sm p-6 space-y-4">
            ...
            <div className="border-t border-sage/30 pt-4">
              <div className="flex justify-between items-center">
                ...
                <span className="font-sans font-bold text-xl md:text-2xl text-[#0FA84F] whitespace-nowrap">{formatCurrency(results.fv)}</span>
              </div>
          ...
          <AreaChart data={chartData} margin={{ top: 4, right: 4, left: 0, bottom: 0 }}>
            <defs>
              <linearGradient id="sipInvested" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#36403B" stopOpacity={0.25} />
