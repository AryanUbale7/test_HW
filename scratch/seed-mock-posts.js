...
async function seed() {
  ...
  const mockPosts = [
    ...
    },
    {
      ...
      cover_image_url: 'https://images.unsplash.com/photo-1447752875215-b2761acb3c5d?auto=format&fit=crop&w=1200&q=80',
      arm: 'Creation',
      type: 'Insight',
      status: 'published',
    ...
    },
    {
      ...
      cover_image_url: 'https://images.unsplash.com/photo-1484154218962-a197022b5858?auto=format&fit=crop&w=1200&q=80',
      arm: 'Creation',
      type: 'Insight',
      status: 'published',
    ...
    },
    {
      ...
      cover_image_url: 'https://images.unsplash.com/photo-1500628557208-0587e727af0c?auto=format&fit=crop&w=1200&q=80',
      arm: 'Creation',
      type: 'News',
    ...
    // --- Protection Pillar (5 Posts) ---
    {
      ...
      cover_image_url: 'https://images.unsplash.com/photo-1581579438747-1dc8d1e0ca96?auto=format&fit=crop&w=1200&q=80',
      arm: 'Protection',
      type: 'Insight',
      status: 'published',
    ...
    },
    {
      ...
      cover_image_url: 'https://images.unsplash.com/photo-1506784983877-45594efa4cbe?auto=format&fit=crop&w=1200&q=80',
      arm: 'Protection',
      type: 'Insight',
      status: 'published',
    ...
    },
    {
      ...
      cover_image_url: 'https://images.unsplash.com/photo-1516627145497-ae6968895b74?auto=format&fit=crop&w=1200&q=80',
      arm: 'Protection',
      type: 'Insight',
      status: 'published',
    ...
    },
    {
      ...
      cover_image_url: 'https://images.unsplash.com/photo-1473448912268-2022ce9509d8?auto=format&fit=crop&w=1200&q=80',
      arm: 'Protection',
      type: 'News',
    ...
    // --- Legacy Pillar (5 Posts) ---
    {
      ...
      cover_image_url: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&w=1200&q=80',
      arm: 'Legacy',
      type: 'Insight',
      status: 'published',
